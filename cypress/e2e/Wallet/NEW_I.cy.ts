...
describe('RIASEC Assessment: All I-Starting Combinations - Submit and Wait for Results', () => {
  const PAUSE = 600;
  const APP_URL = 'https://riasec-app-592805402248.asia-southeast1.run.app';
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyVD70SoQrTQTseM526fMNLeQzFEcY3ky8aHAl38MmSF-vS7TR-I4o3ASQyPXN_nSbC/exec';
