...
describe('RIASEC Assessment: All E-Starting Combinations - Submit and Wait for Results', () => {
  const PAUSE = 600;
  const APP_URL = 'https://riasec-app-592805402248.asia-southeast1.run.app';
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyCClx_Nyl4dBZVCjaGVKnBaUpr2P9JLBnxpLzx3Qbhg0GX4rkbzHhNhvz4xqNpOPjwSg/exec';
