// cypress/e2e/riasec_i_with_google_sheets.cy.ts
...
describe('RIASEC Assessment: I Combinations with Google Sheets Logging', () => {
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbx-3xbQUJEnJU_4OAiJMFkcjY5zBkVsw8D50yC_Cuucyco_msFVQB2q9r6Xin_Yvaek/exec';
