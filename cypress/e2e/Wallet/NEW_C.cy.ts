...
describe('RIASEC Assessment: All C-Starting Combinations - Submit and Wait for Results', () => {
  const PAUSE = 600;
  const APP_URL = 'https://riasec-app-592805402248.asia-southeast1.run.app';
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbylKc8yHzVtEbPOcnF4xmn1pMQTIyDACS0M5L7BMZPhDIhCPTlVEXlLFBFrAxCqk67F8g/exec';
