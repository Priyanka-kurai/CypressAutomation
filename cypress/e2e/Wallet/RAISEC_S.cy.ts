...
describe('RIASEC Assessment: All S-Starting Combinations with Google Sheets Logging', () => {
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbzfHF-SIRBnbqjh68Y5kKvDGRHWTVjC6sIJJz7FE5b8KsAmzXpSNKNidDAZPkOFyTxWVA/exec';
//const SHEET_NAME = 'RIASEC_S';
