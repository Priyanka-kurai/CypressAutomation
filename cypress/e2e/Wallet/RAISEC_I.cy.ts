...
describe('RIASEC Assessment: All I-Starting Combinations with Google Sheets Logging', () => {
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwPirrExosKzXddiCylcsV_ba0uKAF3E-eZMX3vk2N55eyIvmlsy8-ERpKLrp0GaW85/exec';
//const SHEET_NAME = 'RIASEC_I';
 ...
 const I_COMBINATIONS = [
  ...
  // Run tests for all I combinations
