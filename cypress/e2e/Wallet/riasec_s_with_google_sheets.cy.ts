describe('RIASEC Assessment: All S-Starting Combinations (with Google Sheets Logging)', () => {
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwo9bkGVk1VDiMekq69O3rtfnPxWwhYemvDTOGyXpd0jDIMYUM2ECL4UYTvzfCQUWyk/exec';
  ...
  // Test SRA first
  it('should produce SRA result and log to Google Sheets', () => {
    const targetCode = 'SRA';
  ...
  // Test all other S combinations
  S_COMBINATIONS.slice(1).forEach(code => {
