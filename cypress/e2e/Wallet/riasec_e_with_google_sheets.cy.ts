describe('RIASEC Assessment: All E-Starting Combinations (with Google Sheets Logging)', () => {
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxGL0YFneFXRl1d3Z4M-8cEfdc1vq5z7iRsjhlCyV4LB241wDYZyXxfEpR41KgcdaNl/exec';

  // ✅ CORRECT MAPPING based on your actual questions (same mapping as A/S/R files)
