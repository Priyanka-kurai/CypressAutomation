...
describe('RIASEC Assessment: All S-Starting Combinations - Submit and Wait for Results', () => {
  const PAUSE = 600;
  const APP_URL = 'https://riasec-app-592805402248.asia-southeast1.run.app';
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxM8V1K1ndGLBy4qRcKPQfwu7ur4t-_bWXGObV_evmg3N6Z57ADrjjyCvN2y3dE2cFF/exec';
