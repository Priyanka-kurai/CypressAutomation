// cypress/e2e/riasec_all_e_combinations.cy.ts

describe('RIASEC Assessment: All E-Starting Combinations with Google Sheets Logging', () => {
  const PAUSE = 600;
  ...
  const GOOGLE_SHEETS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxTKcci8CZQgjbTKNMKwvtlCPfOAKzwXkEBGj71vR7xvZPiMTrjfLRzbFbB98i81cqKRQ/exec';
  ...
  // Test ERA first with Google Sheets logging
  it('should produce ERA result and log to Google Sheets', () => {
    const targetCode = 'ERA';
  ...
  // Test all other E combinations
  E_COMBINATIONS.slice(1).forEach(code => {
